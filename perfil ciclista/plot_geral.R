...
q03<- data.frame(idade=rep(paste0("f",1:7),1)[order(rep(paste0("f",1:7),1))],
                 #resposta=rep(c("Masculino","Feminino"),7),
                 w=df_03$w[ order(rep(paste0("f",1:7),1))],
                 label=paste0(df_03$w[ order(rep(paste0("f",1:7),1))],"%"))
#q03$resposta <- factor(q03$resposta,c("Masculino","Feminino"))
##
# sparados
#
ggplot(q03,aes(x=factor(idade),y=w))+
  ...
  geom_text(data=q03, 
            aes(x=factor(idade),y=w,  label=q03$label), 
...
q02<- data.frame(idade=rep(paste0("f",1:4),1)[order(rep(paste0("f",1:4),1))],
                 #resposta=rep(c("Masculino","Feminino"),4),
                 w=df_02$w[ order(rep(paste0("f",1:4),1))],
                 label=paste0(df_02$w[ order(rep(paste0("f",1:4),1))],"%"))
#q02$resposta <- factor(q02$resposta,c("Masculino","Feminino"))
resposta_2 <- c("Trabalho","Estudo","Compras","Lazer/Social")
nq_2 <- 04
df_2 <- data.frame("resposta"=resposta_2,"w"=w_2,"label"=paste0(w_2,"%"))
# plot
ggplot(q02,aes(x=factor(idade),y=w))+
  geom_bar(stat="identity",position=position_dodge(),width=0.65,
           size=0.3,colour="black")+
  ...
  geom_text(data=q02, 
            aes(x=factor(idade),y=w,  label=q02$label), 
            position = position_dodge(width=0.75),vjust=-0.35,
            size=2.5)
...
q05<- data.frame(idade=rep(paste0("f",1:5),1)[order(rep(paste0("f",1:5),1))],
                 #resposta=rep(c("Feminino","Masculino"),5),
                 w=df_05$w[ order(rep(paste0("f",1:5),1))],
                 label=paste0(df_05$w[ order(rep(paste0("f",1:5),1))],"%"))
#q05$resposta <- factor(q05$resposta,c("Feminino","Masculino"))
# plot
ggplot(q05,aes(x=factor(idade),y=w))+
  geom_bar(stat="identity",position=position_dodge(),width=0.65,
           size=0.3,colour="black")+
  scale_fill_brewer(palette="Pastel1")+
  ...
  geom_text(data=q05, 
            aes(x=factor(idade),y=w,  label=q05$label), 
            position = position_dodge(width=0.75),vjust=-0.35,
            size=2.5)
...
q10<- data.frame(idade=rep(paste0("f",1:5),1)[order(rep(paste0("f",1:5),1))],
                 #resposta=rep(c("Feminino","Masculino"),5),
                 w=df_10$w[order(rep(paste0("f",1:5),1))],
                 label=paste0(df_10$w[ order(rep(paste0("f",1:5),1))],"%"))
#q10$resposta <- factor(q10$resposta,c("Feminino","Masculino"))
# plot
ggplot(q10,aes(x=factor(idade),y=w))+
  geom_bar(stat="identity",position=position_dodge(),width=0.65,
           size=0.3,colour="black")+
  scale_fill_brewer(palette="Pastel1")+
  ...
  geom_text(data=q10, 
            aes(x=factor(idade),y=w,  label=q10$label), 
            position = position_dodge(width=0.75),vjust=-0.35,
            size=2.5)
...
q15<- data.frame(idade=rep(paste0("f",1:5),1)[order(rep(paste0("f",1:5),1))],
                 #resposta=rep(c("Feminino","Masculino"),5),
                 w=df_15$w[order(rep(paste0("f",1:5),1))],
                 label=paste0(df_15$w[ order(rep(paste0("f",1:5),1))],"%"))
#q15$resposta <- factor(q15$resposta,c("Feminino","Masculino"))
# plot
ggplot(q15,aes(x=factor(idade),y=w))+
  geom_bar(stat="identity",position=position_dodge(),width=0.65,
           size=0.3,colour="black")+
  scale_fill_brewer(palette="Pastel1")+
  ...
  geom_text(data=q15, 
            aes(x=factor(idade),y=w,  label=q15$label), 
            position = position_dodge(width=0.75),vjust=-0.35,
            size=2.5)
...
q18<- data.frame(idade=rep(paste0("f",1:6),1)[order(rep(paste0("f",1:6),1))],
                 #resposta=rep(c("Feminino","Masculino"),6),
                 w=df_18$w[order(rep(paste0("f",1:6),1))],
                 label=paste0(df_18$w[ order(rep(paste0("f",1:6),1))],"%"))
#q18$resposta <- factor(q18$resposta,c("Feminino","Masculino"))
# plot
ggplot(q18,aes(x=factor(idade),y=w))+
  geom_bar(stat="identity",position=position_dodge(),width=0.65,
           size=0.3,colour="black")+
  scale_fill_brewer(palette="Pastel1")+
  ...
  geom_text(data=q18, 
            aes(x=factor(idade),y=w,  label=q18$label), 
            position = position_dodge(width=0.75),vjust=-0.35,
            size=2.5)
...
q16<- data.frame(idade=rep(paste0("f",1:5),1)[order(rep(paste0("f",1:5),1))],
                 #resposta=rep(c("Feminino","Masculino"),5),
                 w=df_16$w[order(rep(paste0("f",1:5),1))],
                 label=paste0(df_16$w[ order(rep(paste0("f",1:5),1))],"%"))
#q16$resposta <- factor(q16$resposta,c("Feminino","Masculino"))
# plot
ggplot(q16,aes(x=factor(idade),y=w))+
  geom_bar(stat="identity",position=position_dodge(),width=0.65,
           size=0.3,colour="black")+
  scale_fill_brewer(palette="Pastel1")+
  ...
  geom_text(data=q16, 
            aes(x=factor(idade),y=w,  label=q16$label), 
            position = position_dodge(width=0.75),vjust=-0.35,
            size=2.5)
